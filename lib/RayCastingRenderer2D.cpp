//
//  RayCastingRenderer2D.cpp
//
//
//  Created by Kun Zhao on 2014-11-10 17:37:30.
//
//
...
/*===========================================================================*/
/**
 *  @brief  Constructs a new RayCastingRenderer2D class.
 */
/*===========================================================================*/
RayCastingRenderer2D::RayCastingRenderer2D():
 ...
 */
/*===========================================================================*/
RayCastingRenderer2D::RayCastingRenderer2D( const kvs::TransferFunction& tfunc ):
    m_draw_front_face( true ),
    m_draw_back_face( true ),
    m_draw_volume( true ),
    m_enable_jittering( false ),
...
RayCastingRenderer2D::RayCastingRenderer2D( const ShadingType shader ):
    m_draw_front_face( true ),
    m_draw_back_face( true ),
    m_draw_volume( true ),
    m_enable_jittering( false ),
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::exec(
    ...
    kvs::Light* light )
{
    ...
    {
        this->initialize_volume_texture( volume, m_volume_texture );
    }

    if ( !m_volume_texture_2.isValid() )
    {
        this->initialize_volume_texture( m_volume_2, m_volume_texture_2 );
    }
    ...
    if ( m_draw_volume )
    {
        ...
        m_ray_casting_shader.bind();
        {
            ...
            /*ADD*/
            kvs::Texture::Binder unit8( m_volume_texture_2, 7 );
            ...
            m_ray_casting_shader.setUniform( "volume_data_2", 7 );
            this->draw_quad( 1.0f );
        }
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::setDrawingBuffer( const RayCastingRenderer2D::DrawingBuffer drawing_buffer )
{
    ...
    {
    case RayCastingRenderer2D::FrontFace: m_draw_front_face = true; break;
    case RayCastingRenderer2D::BackFace: m_draw_back_face = true; break;
    case RayCastingRenderer2D::Volume:
    {
        m_draw_front_face = true;
        m_draw_back_face = true;
        m_draw_volume = true;
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::setTransferFunction( kvs::TransferFunction& tfunc )
{
     BaseClass::setTransferFunction( tfunc );
 ...
 */
/*==========================================================================*/
void RayCastingRenderer2D::initialize_shader( const kvs::StructuredVolumeObject* volume )
{
    // Build bounding cube shader.
    {
        kvs::ShaderSource vert("../../lib/Shader/RC_bounding_cube.vert");
        kvs::ShaderSource frag("../../lib/Shader/RC_bounding_cube.frag");
        m_bounding_cube_shader.build( vert, frag );
    }

    // Build ray caster.
    {
        kvs::ShaderSource vert("../../lib/Shader/RC_ray_caster.vert");
        kvs::ShaderSource frag("../../lib/Shader/RC_ray_caster.frag");
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::initialize_jittering_texture()
{
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::initialize_bounding_cube_buffer( const kvs::StructuredVolumeObject* volume )
{
...
void RayCastingRenderer2D::initialize_transfer_function_texture()
{
    ...
    m_transfer_function_texture.setWrapT( GL_CLAMP_TO_EDGE );
...
void RayCastingRenderer2D::initialize_volume_texture( const kvs::StructuredVolumeObject* volume, kvs::Texture3D& texture )
{
    ...
    texture.setPixelFormat( data_format, GL_ALPHA, data_type );
    texture.setWrapS( GL_CLAMP_TO_BORDER );
    texture.setWrapT( GL_CLAMP_TO_BORDER );
    texture.setWrapR( GL_CLAMP_TO_BORDER );
    texture.setMagFilter( GL_LINEAR );
    texture.setMinFilter( GL_LINEAR );
    texture.create( width, height, depth, data_value.data() );
}
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::initialize_framebuffer( const size_t width, const size_t height )
{
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::update_framebuffer( const size_t width, const size_t height )
{
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::draw_bounding_cube_buffer()
{
 ...
 */
/*===========================================================================*/
void RayCastingRenderer2D::draw_quad( const float opacity )
{
